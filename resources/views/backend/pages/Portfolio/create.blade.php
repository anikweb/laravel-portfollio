                    ...
                    <div class="panel-body">
                        <form action="{{ route('PortfolioPost') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row m-t-sm">
                                ...
                                <div class="col-md-2">
                                    <img id="ThumbnailPreview" width="40%" src="{{ asset('backend/images/no-image.webp') }}" alt="no image">
                                </div>
                            </div>
                            <div class="row ">
                                <div class="col-md-6">
                            ...
                            <div class="row m-t-sm">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" data-role="tagsinput" class="form-control @error('using_technology') @enderror" name="using_technology" id="using_technology">
                                        @error('using_technology')
                                        <div class="text-danger" style="padding:5px 0 !important;" >
                                            <i class="fa fa-info-circle"></i>
                                            {{ $message }}
