                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="social_site_title" id="social_site_title" placeholder="Enter Social Site Title" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group m-b-sm">
                                            ...
                                            <input type="text" class="form-control" name="master_url" id="master_url" placeholder="example.com">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
